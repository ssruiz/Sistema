...
Public Class MesaDeCorteReporte
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Frontend.MesaDeCorteReporte.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_mesa() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedMesaDeCorteReporte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MesaDeCorteReporte = New MesaDeCorteReporte()
        rpt.Site = Me.Site
        Return rpt
    End Function
