...
Public Class CRInformeSalidasPI
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Frontend.CRInformeSalidasPI.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRInformeSalidasPI
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRInformeSalidasPI = New CRInformeSalidasPI()
        rpt.Site = Me.Site
        Return rpt
    End Function
