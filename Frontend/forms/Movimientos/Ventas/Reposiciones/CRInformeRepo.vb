...
Public Class CRInformeRepo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Frontend.CRInformeRepo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRInformeRepo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRInformeRepo = New CRInformeRepo()
        rpt.Site = Me.Site
        Return rpt
    End Function
