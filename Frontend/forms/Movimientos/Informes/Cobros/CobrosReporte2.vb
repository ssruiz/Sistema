...
Public Class CobrosReporte2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Frontend.CobrosReporte2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Cobros_Usuario() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCobrosReporte2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CobrosReporte2 = New CobrosReporte2()
        rpt.Site = Me.Site
        Return rpt
    End Function
