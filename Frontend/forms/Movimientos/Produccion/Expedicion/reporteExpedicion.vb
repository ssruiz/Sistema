...
Public Class reporteExpedicion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Frontend.reporteExpedicion.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_nroExpedicion() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedreporteExpedicion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reporteExpedicion = New reporteExpedicion()
        rpt.Site = Me.Site
        Return rpt
    End Function
